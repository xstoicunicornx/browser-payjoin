...
const pjUri = payjoin.Uri.parse(BIP21_URI).checkPjSupported()           // ✓
const builder = new payjoin.SenderBuilder(psbtBase64, pjUri)            // ✓
...
console.log(withReplyKey instanceof payjoin.WithReplyKey)
